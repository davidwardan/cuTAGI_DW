...
def main(num_epochs: int = 50, batch_size: int = 5):
    ...
    net = Sequential(
        ...
        Linear(8 * input_seq_len, 2), EvenExp()
    )
    # net.to_device("cuda")
    ...
    viz.plot_predictions(
        ...
        sy_pred=std_preds,
        std_factor=1,
        label="heteros_time_series_forecasting",
        title=r"\text{Heteroscedastic Series Forecasting}",
        time_series=True,
    )
