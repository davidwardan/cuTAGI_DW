...
def main(num_epochs: int = 20, batch_size: int = 16, sigma_v: float = 0.5, lstm_nodes: int = 40):
    ...
    out_dir = "david/output/traffic_" + str(num_epochs) + "_" + str(batch_size) + "_" + str(sigma_v) + "_" + str(lstm_nodes) + "_method1"
    ...
    for epoch in pbar:
        ...
        # plot and save mse_val, and ll_val with two different axis
